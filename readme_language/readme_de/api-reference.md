...
Dieses Dokument enthält detaillierte Informationen zu allen API-Endpunkten des CryptoPay Go SDK, einschließlich Anforderungsparametern, Rückgabeparametern und Beispielen.
...
## 5. Benutzerauszahlung (user_withdraw_by_open_id)
