...
> **💡 Consejo:** El Go SDK proporciona el método `VerifyRSASignature(mapData map[string]string, sign string) error` para que los desarrolladores verifiquen rápidamente los datos devueltos por la plataforma.