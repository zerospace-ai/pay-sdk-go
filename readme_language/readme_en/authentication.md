...
> **💡 Tip:** The Go SDK provides the `VerifyRSASignature(mapData map[string]string, sign string) error` method for developers to quickly verify the data returned by the platform.
