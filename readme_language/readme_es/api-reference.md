...
Este documento detalla todos los puntos finales de la API del CryptoPay Go SDK, incluidos los parámetros de solicitud, los parámetros de retorno y los ejemplos.
...
## 5. Retiro de Usuario (user_withdraw_by_open_id)
