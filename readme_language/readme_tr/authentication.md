...
> **💡 İpucu:** Go SDK, geliştiricilerin platform tarafından döndürülen verileri hızlı bir şekilde doğrulaması için `VerifyRSASignature(mapData map[string]string, sign string) error` yöntemini sağlar.