...
このドキュメントでは、リクエストパラメーター、戻り値パラメーター、例など、CryptoPay Go SDK のすべての API エンドポイントについて詳しく説明します。
...
### API の説明
新しいプラットフォームユーザーを作成します。ユーザーの一意の ID である UserOpenId が必要です。
...
## 5. ユーザー出金 (user_withdraw_by_open_id)
