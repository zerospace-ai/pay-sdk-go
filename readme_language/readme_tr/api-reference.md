...
Bu belge, istek parametreleri, dönüş parametreleri ve örnekler dahil olmak üzere CryptoPay Go SDK'nın tüm API uç noktalarını ayrıntılı olarak açıklar.
...
## 5. Kullanıcı Para Çekme (user_withdraw_by_open_id)
