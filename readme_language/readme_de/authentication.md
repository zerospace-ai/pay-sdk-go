...
> **💡 Tipp:** Das Go SDK bietet die Methode `VerifyRSASignature(mapData map[string]string, sign string) error` für Entwickler, um die von der Plattform zurückgegebenen Daten schnell zu überprüfen.